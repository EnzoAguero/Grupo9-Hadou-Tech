...
const mostrarProductos = carrito => {
    ...
    carrito.forEach(item => {
        let product = `
            ...
            <span id="cantidad${item.id}" class="h5" style="color: black;">${item.cantidad}<span>
            ...
            <span style="color: black;">$</span><span class="float-end" style="color: black;">${item.precio}</span>
            </td>
            <td class="align-middle">
            <span style="color: black;">$</span><span class="float-end" style="color: black;">${item.total}</span>
            </td>
            `;
